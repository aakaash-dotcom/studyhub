...
export default function Footer() {
  const footerLinks = {
    'School': ['Class 12', 'Class 11', 'Class 10', 'Class 9', 'Class 8', 'All Classes'],
    'Entrance Exams': ['JEE Main', 'NEET UG', 'CAT', 'CLAT', 'NDA', 'All Exams'],
    'Govt Exams': ['UPSC', 'SSC CGL', 'IBPS PO', 'RRB NTPC', 'CTET', 'All Exams'],
    'Resources': ['Question Papers', 'Sample Papers', 'NCERT Solutions', 'Syllabus', 'Notes', 'All Resources'],
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-6 max-w-sm">
              Your complete study resource for school, entrance exams, and government recruitment exams. 
              All materials organized and accessible from Google Drive.
            </p>
